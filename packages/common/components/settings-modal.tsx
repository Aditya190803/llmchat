...
import { IconBolt, IconBoltFilled, IconSettings2, IconTrash } from '@tabler/icons-react';
        ...
        <div className="flex w-full flex-col gap-6 overflow-x-hidden">
            <div className="flex flex-col">
                ...
                <p className="text-muted-foreground text-xs">
                    Connect your workspace MCP tools.
                </p>
            </div>
...
export const CreditsSettings = () => {
    ...
    const isPro = useChatStore(state => state.creditLimit.isPro);
    ...
    const info = [
        {
            ...
            value: (
                <Badge variant="secondary" className="bg-brand/10 text-brand rounded-full">
                    <span className="text-xs font-medium">{isPro ? 'PRO' : 'FREE'}</span>
                </Badge>
            ),
        },
        {
            ...
            <div className="flex flex-col items-start gap-2">
                ...
                <Alert variant="info" className="w-full">
                    <AlertDescription className="text-muted-foreground/70 text-sm leading-tight">
                        ...
                        contact your admin to continue.
                    </AlertDescription>
                </Alert>
